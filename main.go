...
// https://github.com/karrick/codenames
//
// I MOSTLY NEEDED A SIMPLE SERVICE TO START WITH
// WHICH I CAN ADD MORE FEATURES TO IN ORDER MIMIC
// FAILURE MODES.
...
`)
	...
	accessLogs := &lumberjack.Logger{
		Filename:   "/tmp/codenames.access.log",
		MaxAge:     30,  // days
		MaxBackups: 50,  // count
